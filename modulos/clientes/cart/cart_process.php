...
if(isset($_POST["load_cart"]) && $_POST["load_cart"]==1)
{
	...
	if(isset($_SESSION["products"]) && count($_SESSION["products"])>0){ //if we have session variable
		...
		$cart_box .= "</ul>";
		$cart_box .= '<div class="cart-products-total">Total : $'.sprintf("%01.2f",$total).' <u><a href="view_cart.php" title="Revisa el carrito y la salida">Pagar</a></u></div>';
		die($cart_box); //exit and output content
	}else{
		die("Tu carrito esta vacío"); //we have empty cart
	}
}
